...
| G | Exact four-code, marker, gauge, rank, distance, and noise definitions. |
...
| V | Completed five-gate nontrivial novelty test with an archived search record. |
